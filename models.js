...
const cardInfo = {
  ...
  Russia:
    "**Russia** (United Security Confederation - Defence):\nYou can declare your alliance/country at the start of the game(and only at the start of the game). If you do, draw 1 card from the deck and place it on your country card. You may claim that card as if it was part of your hand.\nAssign 2 counters to your card. When someone performs an Uprising or Assassination against you, you may discard a counter to block that attack. Your counters may not be removed by Italy.",
  China:
    "**China** (United Security Confederation - Utility):\nYou can reveal your country before or after any turn. You may declare your country to immediately perform 1 free action. Place 2 counters on your country card. You may use counters between turns to immediately perform one free action. (1 counter for 1 action). You may spend an action to receive a counter. Each time you take a non-free action, gain 1 token.\nYour counter cap is 4.",
  Japan:
  ...
  India:
    "**India** (United Security Confederation - Utility):\nYou can reveal your country before or after any turn. You may reveal your country to activate this passive:\nIf you lose a challenge, you may pay 4 tokens to gain a life after resolving the challenge. If India’s amount of allies exceeds 2, reduce cost to 3 tokens.",
  DPRK: "**North Korea** (Neutral):\nYou can reveal your country before or after any turn.\nYou may reveal your country to draw as many counters as there are revealed alive players (capped at 8). You may spend your counters to heal back a life or to gain 5 tokens, disabled when the amount of alive players reaches 4.",
  Switzerland:
    "**Switzerland** (Neutral):\nYou can reveal your country before or after any turn.\nYou may reveal your country to activate this action and passive:\nPassive: Whenever you take 1 damage, choose a player. That player also takes 1 damage.\nACTION: Pay 4 tokens to the bank. Target player reveals his country and cards to you.\nYour passives and exclusive action are disabled when the amount of alive players reaches 4.",
  Israel:
    "**Israel** (Neutral):\nYou can reveal your country before or after any turn.\nYou may reveal your country to active this passive:\nYour claims may not be challenged.\nIn addition, increase your hand size to 4 and draw a card.\nYour passives are disabled when the amount of alive players reaches 4.",
  Minister:
    "**Minister** (Blue Strip, 4 in a deck):\nAbility #1: Draw 3 tokens from the Reserve.\nYou may not claim the Minister if you have Red Strip cards in your hand.",
  President:
    "**President** (Blue Strip, 2 in a deck):\nAbility #1: You may draw up to X+2 tokens from the Reserve. X is defined as the amount of other players in the game divided by 2 rounded up. Starting from the player on your left (going clockwise), take tokens from the Reserve and give [X+1] players 1 token each. ",
  Entrepreneur:
    "**Entrepreneur** (Blue Strip, 3 in a deck):\nAbility #1: Draw 4 tokens from the Reserve. Place 1 token into the Holding Area. You may not claim Blue Strip, Sentry Guard or General or Income on your subsequent action.\nAbility #2: Block Scout targeted at you (Passive)",
  Politician:
  ...
  Medic:
    "**Medic** (Red Strip, 3 in a deck):\nAbility #1: Pay 9 tokens to the Reserve. First, draw a card to your hand. Then, you may choose to discard a card from your hand to draw another card. You may only claim this card if your current hand size is lower than your maximum hand size.\nAbility #2 (Passive): When a player loses a life, you may pay 2 tokens to the Reserve to swap a card from your hand with the revealed card.",
  "Bounty Hunter":
    "**Bounty Hunter** (Red Strip, 4 in a deck):\nAbility #1: Pay 3 tokens to the Reserve and 1 token to the Holding Area to make the target player lose a life. (Blocked by Sentry Guard, Activist and Politician)\nAbility #2: Block Commissar (Passive)",
  "Sentry Guard":
